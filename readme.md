...
## Zones
And speaking about the zones, I think about some of my favourite obscure zones in the entire Classic Sonic series, including the 8-bit games. I'm planning for Emerald Hill Zone, Starlight Zone, Bridge Zone, Sunset Park Zone, Diamond Dust Zone, Lava Reef Zone, Hidden Palace Zone (from Sonic 3&K, not Sonic 2), Sandopolis Zone, Underground Zone, Gigalopolis Zone (or Gigapolis), Tidal Tempest Zone, Quartz Quadrant Zone, Aquatic Ruin Zone, Crystal Egg Zone and Sky Chase Zone. Or, maybe I'll plan for new ones, for example, I've recently planned on a final zone called Egg Palace Zone. It will feature mirrors utilised in a very stange way (and a lot of sonics and stuff), speed sections (maybe like rainbow roads but not with rainbow colors exactly) as well as platforming sections (maybe I'll look for something like this in Silver Castle Zone from Sonic Blast, sorry 😅) some real royal palace vibes mixed with some factory machinery, and a final boss with all the zone's elements.
